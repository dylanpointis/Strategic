<%@ Page Title="Nueva familia" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AltaFamilia.aspx.cs" Inherits="Strategic.AltaFamilia" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main class="page-section">
        ...
        <div class="page-heading">
            <h1>Nueva familia</h1>
            <p>Combiná permisos simples y familias que ya existan para armar una nueva.</p>
        </div>
        ...
        <asp:Panel ID="pnlFormulario" runat="server" CssClass="strategic-card">
            ...
            <div class="strategic-card-body">
                ...
                <div class="formulario-acciones">
                    <asp:Button ID="btnGuardar" runat="server" Text="Crear familia" CssClass="btn btn-strategic" ValidationGroup="Familia" OnClick="btnGuardar_Click" />
