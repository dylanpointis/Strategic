...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main class="page-section">
        ...
        <div class="page-heading">
            <h1>Dar de baja competidor</h1>
            <p>Confirmación de baja o reactivación de un competidor.</p>
        </div>
        ...
        <asp:Panel ID="pnlConfirmacion" runat="server" CssClass="strategic-card">
            ...
            <div class="strategic-card-body">
                <div class="confirmacion">
                    ...
                    <asp:Label ID="lblAdvertenciaPublicaciones" runat="server" CssClass="mensaje-aviso" Visible="false"></asp:Label>
