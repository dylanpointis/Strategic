<%@ Page Title="Dar de baja familia" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BajaFamilia.aspx.cs" Inherits="Strategic.BajaFamilia" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main class="page-section">
        ...
        <div class="page-heading">
            ...
            <p>Confirmación de baja o reactivación de una familia de permisos.</p>
        </div>
