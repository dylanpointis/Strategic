<%@ Page Title="Historial de stock" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HistorialStock.aspx.cs" Inherits="Strategic.HistorialStock" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main class="page-section">
        ...
        <div class="page-heading">
            ...
            <p>Evolución histórica del stock disponible de cada producto.</p>
        </div>
        ...
        <section class="strategic-card">
            ...
            <div class="strategic-card-body sin-padding">
                <sc:GrillaGenerica ID="grillaStock" runat="server" />
            </div>
        </section>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptsFinales" runat="server">
    ...
    <script type="text/javascript">
        Strategic.grafico.linea('graficoStock', <%= DatosGraficoJson %>, 'Stock', '');
    </script>
</asp:Content>
